...
use boson::{index_secret, public_key, Clock, D};
...
fn main() -> anyhow::Result<()> {
    ...
    write(
        ...
        circuit
            .data
            .to_bytes(
                &ser::DefaultGateSerializer,
                &ser::DefaultGeneratorSerializer::<PoseidonGoldilocksConfig, D>::default(),
            )
